      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex justify-center gap-4 mb-12">
          <Button
            ...
            size="lg"
            className={activeTab === "idea" ? "bg-gradient-to-r from-green-600 to-emerald-600" : ""}
          >
          ...
          <Button
            ...
            size="lg"
            className={activeTab === "skill" ? "bg-gradient-to-r from-green-600 to-emerald-600" : ""}
          >
            ...
            <Card className="mb-12 border-2 shadow-xl">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3">
                  <Button onClick={() => navigate("/post-idea")} size="lg" className="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700">
                    Find Builders with AI
                  </Button>
            ...
            <div className="space-y-4">
              {ideas.map((idea, index) => (
                <motion.div
                  ...
                  whileHover={{ y: -4 }}
                >
                  <Card className="border-2 hover:border-green-300 transition-all shadow-md hover:shadow-xl">
                    <CardHeader>
                      <div className="flex items-start justify-between">
                        ...
                        <Lightbulb className="w-8 h-8 text-green-500 flex-shrink-0 ml-2" />
                      </div>
